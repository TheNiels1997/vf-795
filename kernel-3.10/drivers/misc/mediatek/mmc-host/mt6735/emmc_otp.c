...
// #PR922046 added by chuanbo qiu for otp support
...
// #PR922046 added by chuanbo qiu for otp support begin
...
#define TRACE_REGION "/dev/block/platform/mtk-msdc.0/by-name/proinfo" //"/dev/pro_info"
...
// #PR101413 added by chuanbo qiu for otp support end
...
static long mt_otp_ioctl(struct file *file, unsigned int cmd, unsigned long arg)
{
	...
	//#922046 added by chuanbo qiu for otp support begin
	printk("OTP IOCTL: no changed  otpctl offset is %d\n", otpctl.Offset);
	id_offset(&otpctl);
	//#PR101413 added by chuanbo qiu for otp support end
	...
	//#PR922046 added by chuanbo qiu for otp support	
	printk("OTP IOCTL: no changed  otpctl length is %d\n", otpctl.Length);
	...
	case EMMC_OTP_READ:
		...
		printk(KERN_ERR "[%s]: -----------------------------------\n", __func__);
		//#PR922046 added by chuanbo qiu for otp support end
	...
	default:
		//#PR922046 added by chuanbo qiu for otp support		
		printk("OTP IOCTL: Invalid command\n");
		ret = -EINVAL;
	}
