...
/* Modify by shitao.qiu@tcl.com begin */
	//u32 ints[2]={0,0};
	u32 ints[2]={GPIO_ACCDET_EINT_PIN,CUST_EINT_ACCDET_DEBOUNCE_CN};
/* Modify by shitao.qiu@tcl.com end */
...
/* Modify by shitao.qiu@tcl.com begin */
		if(cali_voltage==13){
			ACCDET_DEBUG("[Accdet__LLF] this key is cause by plug-out! and abanden it\n");
			return ;
		}
/* Modify by shitao.qiu@tcl.com end */
...
{ 
   ...
   #ifdef ACCDET_EINT_IRQ
/* Modify by shitao.qiu@tcl.com begin */
	pmic_pwrap_write(ACCDET_RSV, pmic_pwrap_read(ACCDET_RSV)|ACCDET_INPUT_MICP);//add by llf
    pmic_pwrap_write(ACCDET_ADC_REG, pmic_pwrap_read(ACCDET_ADC_REG)|0x20);//switch P internel
/* Modify by shitao.qiu@tcl.com end */
