...
// Modify.
#include "open_test_RIU1_BYD.h"
#include "open_test_RIU2_BYD.h"
#include "open_test_RIU3_BYD.h"
...
// Modify.
#include "short_test_RIU1_BYD.h"
#include "short_test_RIU2_BYD.h"
#include "short_test_RIU3_BYD.h"
#ifdef CONFIG_ENABLE_MP_TEST_ITEM_FOR_2R_TRIANGLE  
#include "short_test_RIU4_BYD.h"
#endif //CONFIG_ENABLE_MP_TEST_ITEM_FOR_2R_TRIANGLE
...
static u16 _DrvMpTestItoTestChooseTpType(void)
{
    ...
    if (TP_OF_X == nTpType) // Modify. 
    {
...
#endif //CONFIG_ENABLE_MP_TEST_ITEM_FOR_2R_TRIANGLE
#elif defined(CONFIG_ENABLE_CHIP_MSG22XX)
        _gOpenRIU1 = open_1_BYD;
        _gOpenRIU2 = open_2_BYD;
        _gOpenRIU3 = open_3_BYD;

        _gShort_RIU1 = short_1_BYD;
        _gShort_RIU2 = short_2_BYD;
        _gShort_RIU3 = short_3_BYD;

        _gOpenSubFrameNum1 = NUM_OPEN_1_SENSOR_BYD;
        _gOpenSubFrameNum2 = NUM_OPEN_2_SENSOR_BYD;
        _gOpenSubFrameNum3 = NUM_OPEN_3_SENSOR_BYD;
        _gShortSubFrameNum1 = NUM_SHORT_1_SENSOR_BYD;
        _gShortSubFrameNum2 = NUM_SHORT_2_SENSOR_BYD;
        _gShortSubFrameNum3 = NUM_SHORT_3_SENSOR_BYD;

#ifdef CONFIG_ENABLE_MP_TEST_ITEM_FOR_2R_TRIANGLE
        _gShort_RIU4 = short_4_BYD;
        _gShortSubFrameNum4 = NUM_SHORT_4_SENSOR_BYD;
#endif //CONFIG_ENABLE_MP_TEST_ITEM_FOR_2R_TRIANGLE
#endif
        ...
        _gMAP2 = MAP2_BYD;
        _gMAP3 = MAP3_BYD;
        _gMAP40_1 = MAP40_1_BYD;
        _gMAP40_2 = MAP40_2_BYD;
        _gMAP41_1 = MAP41_1_BYD;
        _gMAP41_2 = MAP41_2_BYD;

        _gSHORT_MAP1 = SHORT_MAP1_BYD;
        _gSHORT_MAP2 = SHORT_MAP2_BYD;
        _gSHORT_MAP3 = SHORT_MAP3_BYD;

#ifdef CONFIG_ENABLE_MP_TEST_ITEM_FOR_2R_TRIANGLE       
        _gMAP40_3 = MAP40_3_BYD;
        _gMAP40_4 = MAP40_4_BYD;
        _gMAP41_3 = MAP41_3_BYD;
        _gMAP41_4 = MAP41_4_BYD;

        _gSHORT_MAP4 = SHORT_MAP4_BYD;
#endif //CONFIG_ENABLE_MP_TEST_ITEM_FOR_2R_TRIANGLE
 
        _gItoTestKeyNum = NUM_KEY_BYD;
        _gItoTestDummyNum = NUM_DUMMY_BYD;
        _gItoTestTriangleNum = NUM_SENSOR_BYD;
        _gIsEnable2R = ENABLE_2R_BYD;
    }
...
//        RegSet16BitValue(0x1110, 0x0060); // 2.4V -> 1.2V
    ...
    if (nSensorNum > MAX_SUBFRAME_NUM)
    {
        ...
        for (i = 0; i < MAX_SUBFRAME_NUM; i ++)//modify by xiewei@tcl
        {
