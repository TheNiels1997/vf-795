...
#define  GPIO_CTP_RST_PIN  (GPIO61 | 0x80000000) 
...
int fts_ctpm_auto_upg(unsigned char tp_vendor)
{
        ...
        unsigned char version_list_pixi45_3407_tdt[] = {0x00,0x01,0x02,0x10,0x11,0x12,0x13,0x14,0x15,0x16,0x60,0x61,0x62,0x63,0x64,0x65,0x66,0x67,0x80,0x81,0x82};
...
//	i2c_client->dev.coherent_dma_mask = DMA_BIT_MASK(32); 
//	g_dma_buff_va = (u8 *)dma_alloc_coherent(&i2c_client->dev, 255, &g_dma_buff_pa, GFP_KERNEL);
    g_dma_buff_va = (u8 *)dma_alloc_coherent(NULL, 255, &g_dma_buff_pa, GFP_KERNEL);
	if(!g_dma_buff_va)
	{
