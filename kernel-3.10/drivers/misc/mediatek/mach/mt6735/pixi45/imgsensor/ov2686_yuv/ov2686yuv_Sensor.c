...
OV2686_write_cmos_sensor(0x5182,0x41);
OV2686_write_cmos_sensor(0x5183,0x42);
OV2686_write_cmos_sensor(0x5184,0x7d);
OV2686_write_cmos_sensor(0x5185,0x5e);
OV2686_write_cmos_sensor(0x5186,0x9c);
OV2686_write_cmos_sensor(0x5187,0xa7);
OV2686_write_cmos_sensor(0x5188,0x14);
OV2686_write_cmos_sensor(0x5189,0x14);
OV2686_write_cmos_sensor(0x518a,0x12);
OV2686_write_cmos_sensor(0x518b,0x3c);
OV2686_write_cmos_sensor(0x518c,0x3f);
OV2686_write_cmos_sensor(0x518d,0xf5);
OV2686_write_cmos_sensor(0x518e,0xa );
OV2686_write_cmos_sensor(0x518f,0x7f);
OV2686_write_cmos_sensor(0x5190,0x40);
OV2686_write_cmos_sensor(0x5191,0x5f);
OV2686_write_cmos_sensor(0x5192,0x40);
OV2686_write_cmos_sensor(0x5193,0xff);
OV2686_write_cmos_sensor(0x5194,0x40);
OV2686_write_cmos_sensor(0x5195,0x4 );
OV2686_write_cmos_sensor(0x5196,0xe8);
OV2686_write_cmos_sensor(0x5197,0x4 );
OV2686_write_cmos_sensor(0x5198,0x0 );
OV2686_write_cmos_sensor(0x5199,0x7 );
OV2686_write_cmos_sensor(0x519a,0xbb);
OV2686_write_cmos_sensor(0x519b,0x4 );
        ...
        MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData)
{
    ...
    pSensorInfo->PreviewDelayFrame = 2; // 12
