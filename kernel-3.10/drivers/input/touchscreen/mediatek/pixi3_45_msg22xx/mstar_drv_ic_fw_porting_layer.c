...
extern unsigned char msg2238_is_suspend;//add by xiewei@tcl
unsigned char msg2238_psensor_enable = 0;
/*=============================================================*/
...
{
//    DBG("*** %s() ***\n", __func__);
    if (msg2238_is_suspend == 1)//add by xiewei@tcl for p-sensor
    {
	 msg2238_psensor_enable	= 1;
	 printk("pls msg2238_psensor_enable=1\n");
	 return 0;
    }
...
{
//    DBG("*** %s() ***\n", __func__);
    msg2238_psensor_enable  = 0;//add by xiewei@tcl for p-sensor
