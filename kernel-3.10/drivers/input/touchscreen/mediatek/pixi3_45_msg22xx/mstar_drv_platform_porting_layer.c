...
const int g_TpVirtualKey[] = {KEY_BACK,KEY_HOMEPAGE,KEY_MENU, /*, TOUCH_KEY_SEARCH*/};

//#ifdef CONFIG_ENABLE_REPORT_KEY_WITH_COORDINATE
#define BUTTON_W (150)
#define BUTTON_H (150)

const int g_TpVirtualKeyDimLocal[MAX_KEY_NUM][4] = {{80,900,160,BUTTON_H},{240,900,160,BUTTON_H},{400,900,160,BUTTON_H} };
...
s32 DrvPlatformLyrTouchDeviceRegisterFingerTouchInterruptHandler(void)
{
	...
	printk("hello running here\n");
        ...
        mt_eint_registration(CUST_EINT_TOUCH_PANEL_NUM, EINTF_TRIGGER_RISING/* EINTF_TRIGGER_RISING */, _DrvPlatformLyrFingerTouchInterruptHandler, 1);
