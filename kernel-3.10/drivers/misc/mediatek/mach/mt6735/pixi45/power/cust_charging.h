...
#define CHARGE_TEMPERATURE_STEP1 38
#define CHARGE_TEMPERATURE_STEP2 42
#define CHARGE_TEMPERATURE_STEP3 45
#define HIGH_TEMPERATURE_RECOVER 50

/* Linear Charging Threshold */
#define V_PRE2CC_THRES	 		3400	//mV
#define V_CC2TOPOFF_THRES		4050
#define RECHARGING_VOLTAGE      4270
/*change the charge full current to cut down the charge time by liyue yueli@tcl.com */
