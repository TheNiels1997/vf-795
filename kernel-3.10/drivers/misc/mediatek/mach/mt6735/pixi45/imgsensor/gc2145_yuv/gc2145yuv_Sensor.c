...
kal_uint16 GC2145_read_shutter(void)
{
	...
	temp_reg1 = GC2145_read_cmos_sensor(0x04);
	temp_reg2 = GC2145_read_cmos_sensor(0x03);
...
static void GC2145_Sensor_Init(void)
{
	...
	GC2145_write_cmos_sensor(0x85 , 0x0b); //08
	...
	GC2145_write_cmos_sensor(0x43 , 0x5c); //5b
	...
	GC2145_write_cmos_sensor(0x1f , 0x45);//35//3a//45
	GC2145_write_cmos_sensor(0x20 , 0x75);//40//45//50
	...
	GC2145_write_cmos_sensor(0xb6 , 0x18);//38//18//
	GC2145_write_cmos_sensor(0xb7 , 0x02);
	GC2145_write_cmos_sensor(0xb9 , 0x40);//28//38//48
	...
	GC2145_write_cmos_sensor(0xc3,0x1f);
	GC2145_write_cmos_sensor(0xc4,0x17);
	GC2145_write_cmos_sensor(0xc8,0x1f);
	GC2145_write_cmos_sensor(0xc9,0x1b);
	GC2145_write_cmos_sensor(0xca,0x1a);
	GC2145_write_cmos_sensor(0xbc,0x3d);
	GC2145_write_cmos_sensor(0xbd,0x30);
	GC2145_write_cmos_sensor(0xbe,0x28);
	GC2145_write_cmos_sensor(0xb6,0x40);
	GC2145_write_cmos_sensor(0xb7,0x32);
	GC2145_write_cmos_sensor(0xb8,0x2d);
	...
	GC2145_write_cmos_sensor(0xcc,0x07);
	GC2145_write_cmos_sensor(0xcd,0x00);
	GC2145_write_cmos_sensor(0xbf,0x00);
	GC2145_write_cmos_sensor(0xc0,0x00);
	GC2145_write_cmos_sensor(0xc1,0x00);
	GC2145_write_cmos_sensor(0xb9,0x04);
	GC2145_write_cmos_sensor(0xba,0x00);
	GC2145_write_cmos_sensor(0xbb,0x03);
	GC2145_write_cmos_sensor(0xaa,0x11);
	GC2145_write_cmos_sensor(0xab,0x00);
	GC2145_write_cmos_sensor(0xac,0x00);
	GC2145_write_cmos_sensor(0xad,0x0b);
	GC2145_write_cmos_sensor(0xae,0x00);
	GC2145_write_cmos_sensor(0xaf,0x00);
	GC2145_write_cmos_sensor(0xb0,0x1c);
	GC2145_write_cmos_sensor(0xb1,0x0f);
	GC2145_write_cmos_sensor(0xb2,0x0d);
	GC2145_write_cmos_sensor(0xb3,0x0f);
	GC2145_write_cmos_sensor(0xb4,0x09);
	GC2145_write_cmos_sensor(0xb5,0x09);
	GC2145_write_cmos_sensor(0xd0,0x00);
	GC2145_write_cmos_sensor(0xd1,0x0f);
	GC2145_write_cmos_sensor(0xd2,0x10);
	GC2145_write_cmos_sensor(0xd6,0x07);
	GC2145_write_cmos_sensor(0xd7,0x00);
	GC2145_write_cmos_sensor(0xd8,0x09);
	GC2145_write_cmos_sensor(0xd9,0x00);
	GC2145_write_cmos_sensor(0xda,0x00);
	GC2145_write_cmos_sensor(0xdb,0x00);
	GC2145_write_cmos_sensor(0xd3,0x00);
	GC2145_write_cmos_sensor(0xd4,0x09);
	GC2145_write_cmos_sensor(0xd5,0x00);
	GC2145_write_cmos_sensor(0xa4,0x00);
	GC2145_write_cmos_sensor(0xa5,0x00);
	GC2145_write_cmos_sensor(0xa6,0x00);
	GC2145_write_cmos_sensor(0xa7,0x00);
	GC2145_write_cmos_sensor(0xa8,0x00);
	GC2145_write_cmos_sensor(0xa9,0x00);
	...
	GC2145_write_cmos_sensor(0xe7 , 0x88);//a0 
...
//	GC2145_write_cmos_sensor(0x4e , 0x07);
	...
	GC2145_write_cmos_sensor(0x67 , 0xb8);//a8//e7
	GC2145_write_cmos_sensor(0x68 , 0xb0);//b0//97
	GC2145_write_cmos_sensor(0x69 , 0x00);
	GC2145_write_cmos_sensor(0x6a , 0xb8);//a8//e7
	GC2145_write_cmos_sensor(0x6b , 0xb0);//b0//97
	GC2145_write_cmos_sensor(0x6c , 0xb8);//af
	GC2145_write_cmos_sensor(0x6d , 0xb0);//8b
	GC2145_write_cmos_sensor(0x6e , 0x50);//50
	GC2145_write_cmos_sensor(0x6f , 0x38);//18
	GC2145_write_cmos_sensor(0x73 , 0xf0);//d0  f0//xihaose//c3
	...
	GC2145_write_cmos_sensor(0xC1 , 0x46);//48//46
	GC2145_write_cmos_sensor(0xc2 , 0x00);//f8//00
	...
	GC2145_write_cmos_sensor(0xc8 , 0xf4);//f2
	...
	GC2145_write_cmos_sensor(0xcd , 0x4a);//48
	...
	GC2145_write_cmos_sensor(0x2b , 0x0b); 
	GC2145_write_cmos_sensor(0x2c , 0xb8); //12fps//7d0
	GC2145_write_cmos_sensor(0x2d , 0x0d); 
	GC2145_write_cmos_sensor(0x2e , 0xac); //8fps
	GC2145_write_cmos_sensor(0xfe , 0x00);
					  ...
					  MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
    ...
    ///////add  log/////////////// 
  //  GC2145_write_cmos_sensor(0xfe, 0x01);
  //  kal_uint16 sensor_awb_temp;
 //	sensor_awb_temp=GC2145_read_cmos_sensor(0x8a);
 //   SENSORDB("GC2145_AWB_temp:%x \n",sensor_awb_temp);
    ////////////////////////////
	Sleep(200);
...
void GC2145GetExifInfo(UINT32 exifAddr)
{
	kal_uint32 shutter,step,exp_time;
	
	shutter = GC2145_read_shutter();

	GC2145_write_cmos_sensor(0xfe , 0x01);	
	step=(GC2145_read_cmos_sensor(0x25) << 8)|GC2145_read_cmos_sensor(0x26);
	GC2145_write_cmos_sensor(0xfe , 0x00);

	exp_time=shutter*1000*10/step;

	SENSOR_EXIF_INFO_STRUCT* pExifInfo = (SENSOR_EXIF_INFO_STRUCT*)exifAddr;
	pExifInfo->FNumber = 28;
	pExifInfo->AEISOSpeed = AE_ISO_100;
	pExifInfo->AWBMode =FID_AWB_MODE;
	pExifInfo->CapExposureTime = exp_time;
...
BOOL GC2145_set_param_banding(UINT16 para)
{
    switch (para)
    {
		...
		GC2145_write_cmos_sensor(0x2b , 0x0b); 
		GC2145_write_cmos_sensor(0x2c , 0x60); //12fps //820
		GC2145_write_cmos_sensor(0x2d , 0x0d); 
		GC2145_write_cmos_sensor(0x2e , 0x00); //8fps
		GC2145_write_cmos_sensor(0xfe , 0x00);
            break;
...
BOOL GC2145_set_param_exposure(UINT16 para)
{
	...
	switch (para)
	{
		...
		case AE_EV_COMP_00:
			GC2145_SET_PAGE1;
			GC2145_write_cmos_sensor(0x13,0x7b);//7b
			GC2145_SET_PAGE0;
		break;
		case AE_EV_COMP_10:
			GC2145_SET_PAGE1;
							 ...
							 UINT8 *pFeaturePara,UINT32 *pFeatureParaLen)
{
	...
	switch (FeatureId)
	{
		...
		case SENSOR_FEATURE_SET_YUV_CMD:
		     //printk("debug by qiuwang GC2145 YUV sensor Setting:%llu, %llu \n", *feature_data,  *(feature_data+1));
		...
		case SENSOR_FEATURE_GET_EXIF_INFO:
		     ...
		     GC2145GetExifInfo(*pFeatureData32);
		     break;	
		default:
			break;			
	}
