...
static unsigned char CTPM_FW[] = {
	#include "TCL_PIXI3_45_4G_3407_TDT0xe0_Ver0x82_20150513_app.i"
};
...
*/
unsigned char fts_ctpm_update_project_setting(struct i2c_client *client)
{
	...
	*/
	if(fts_updateinfo_curr.CHIP_ID==0x06 || fts_updateinfo_curr.CHIP_ID==0x36 || fts_updateinfo_curr.CHIP_ID==0x0E )
	{
