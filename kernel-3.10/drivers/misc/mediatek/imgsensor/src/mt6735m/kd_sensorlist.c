...
inline static int kdSetSensorGpio(int *pBuf)
{
   int ret = 0;
	...
	// It is not necessary to config pins at here in code base of V0.7 ! 
#if 0
    printk("TCL:[CAMERA SENSOR] kdSetSensorGpio enable=%d, type=%d\n",
    ...
    if (pSensorgpio->SensroInterfaceType == SENSORIF_PARALLEL){
            mt_set_gpio_mode((GPIO42 | 0x80000000), GPIO_MODE_01); /* CMDAT0 */
  	        mt_set_gpio_mode((GPIO43 | 0x80000000), GPIO_MODE_01); /* CMDAT1 */
            mt_set_gpio_mode((GPIO41 | 0x80000000), GPIO_MODE_02); /* CMDAT2 */
            mt_set_gpio_mode((GPIO40 | 0x80000000), GPIO_MODE_02); /* CMDAT3 */
            mt_set_gpio_mode((GPIO39 | 0x80000000), GPIO_MODE_02); /* CMDAT4 */
            mt_set_gpio_mode((GPIO38 | 0x80000000), GPIO_MODE_02); /* CMDAT5 */
            mt_set_gpio_mode((GPIO37 | 0x80000000), GPIO_MODE_02); /* CMDAT6 */
            mt_set_gpio_mode((GPIO36 | 0x80000000), GPIO_MODE_02); /* CMDAT7 */
            mt_set_gpio_mode((GPIO32 | 0x80000000), GPIO_MODE_02); /* CMHSYNC */
            mt_set_gpio_mode((GPIO33 | 0x80000000), GPIO_MODE_02); /* CMVSYNC */
            mt_set_gpio_mode((GPIO45 | 0x80000000), GPIO_MODE_01); //mclk
            mt_set_gpio_mode((GPIO44 | 0x80000000), GPIO_MODE_01);  //plck
     
	 		mt_set_gpio_mode((GPIO34 | 0x80000000), GPIO_MODE_02); /* CMDAT6 */
            mt_set_gpio_mode((GPIO35 | 0x80000000), GPIO_MODE_02); /* CMDAT7 */
...
* CAMERA_HW_i2c_probe
********************************************************************************/
 // add by zhangxinghong  at 20150116 start
...
// add by zhangxinghong  at 20150116  end
static int CAMERA_HW_i2c_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
    ...
    Create_Camera_node_ForMMI();   //add by zhangxinghong
