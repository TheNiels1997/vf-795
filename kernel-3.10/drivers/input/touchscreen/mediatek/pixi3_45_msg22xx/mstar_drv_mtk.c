...
unsigned char msg2238_is_suspend = 0;
extern unsigned char msg2238_psensor_enable;
...
static int /*__devinit*/ tpd_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
    ...
    tpd_load_status = 1;
    tp_vendor_id_ps = 0x0E; //msg2238 p-sensor ID
...
static void tpd_resume(struct early_suspend *h)
{
    ...
    if (msg2238_psensor_enable == 1)//add by xiewei@tcl for p-sensor
    {
	msleep(200);
	DrvFwCtrlEnableProximity();
	printk("enable pls in tpd_resume\n");
	msg2238_psensor_enable = 0;
    }
   
    msg2238_is_suspend  = 0;
...
static void tpd_suspend(struct early_suspend *h)
{
    ...
    msg2238_is_suspend = 1;//add by xiewei@tcl for p-sensor
