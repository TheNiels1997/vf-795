...
static void lcm_get_params(LCM_PARAMS *params)
{
	...
	//for esd protest end by legen
        ...
        params->dsi.HS_TRAIL = 5;//modify MIPI HS-TRA Timing from platform ddp-dsi by ke.li@tcl.com [PR 1027931]
        params->dsi.HS_PRPR = 4;//HS-PREPARE Timing [PR 1027931]
